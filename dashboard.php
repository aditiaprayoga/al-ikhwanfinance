...
<head>
    ...
    <title>Al-IkhwanFinance - Dashboard</title>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Al-Ikhwan</h3>
        <h3 class="text-secondary float-left logo2">- Finance</h3>
        <a href="logout">
            <div class="logout">
